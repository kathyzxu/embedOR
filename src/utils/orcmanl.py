### from https://github.com/TristanSaidi/orcml/blob/main/src/orcmanl.py
...
shortcut_str = "Shortcut Edge Detected: edge {num}\n d_G'(x,y)/\|x-y\|_2: {emp_ratio}\n Threshold/\|x-y\|_2: {theo_ratio}\n\n"
...
class ORCManL(object):
    ...
    def _validate_and_prune(self):
        ...
        for num, (i, j) in enumerate(self.C):
            ...
            threshold = self.dist_threshold * weight
            ...
            if d_G_prime > threshold:
                ...
                if self.verbose:
                    print(shortcut_str.format(num=num, emp_ratio=d_G_prime/weight, theo_ratio=threshold/weight))
            else:
